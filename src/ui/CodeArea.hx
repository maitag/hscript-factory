...
class CodeArea extends UIArea
{
	public function new()
	{
		...
		var header = new UITextLine<UiFontStyle>(gap, gap,
			...
			"Hscript", Ui.font, Ui.fontStyleFG, { backgroundStyle:Ui.styleBG, hAlign:HAlign.CENTER }
		);
		...
		var sliderConfig:SliderConfig = {
			backgroundStyle: Ui.styleBG.copy(Color.GREY1, Color.GREY1, 0),
			draggerStyle: Ui.styleBG.copy(Color.GREY2, Color.GREY1, 0),
